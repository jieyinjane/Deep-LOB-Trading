...
def DCNN_training(data):
    ...
    N = 41
    dec_train = data.iloc[int(dimension*0.8):int(dimension*0.9), 1:N].reset_index(drop=True)
    ...
    dec_valid = data.iloc[int(dimension*0.9):int(dimension*0.95), 1:N].reset_index(drop=True)
    ...
    dec_test = data.iloc[int(dimension*0.95):int(dimension), 1:N].reset_index(drop=True)
